...
//        messageList.setAvatarShape(1);
    ...
    public EaseChatPrimaryMenuBase.EaseChatPrimaryMenuListener getChatPrimaryMenuListener(){
        return inputMenu.getChatPrimaryMenuListener();
    }
...
//                REQUEST_CODE_CAMERA);
        Intent intent = com.hyphenate.easeui.utils.ImageUtils.getImageCaptureIntent(getUriForFile(cameraFile));
    ...
    private Uri getUriForFile(File file) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            uri = FileProvider.getUriForFile(getContext(), "com.lanmei.bilan.fileprovider", file);
        } else {
