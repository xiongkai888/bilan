...
import com.lanmei.bilan.adapter.ItemImageAdapter;
...
public class SudokuView extends RelativeLayout {
    ...
    public void setListData(final List<String> list) {
        ...
        if (!StringUtils.isEmpty(list) && list.size() == 1) {
            ...
            ImageHelper.load(getContext(), list.get(0), oneImageView, null, true, R.mipmap.default_pic_b, R.mipmap.default_pic_b);
