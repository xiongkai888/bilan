 ...
 * 行情--交易所
 */
public class MarketJiaoAdapter extends SwipeRefreshAdapter<HomeQuBean> {


    public MarketJiaoAdapter(Context context) {
        super(context);
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder2(ViewGroup parent, int viewType) {
        ...
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_market_jiao, parent, false));
    }
