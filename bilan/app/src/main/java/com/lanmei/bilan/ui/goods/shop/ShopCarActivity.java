package com.lanmei.bilan.ui.goods.shop;
...
public class ShopCarActivity extends BaseActivity implements ShopCartContract.View, Toolbar.OnMenuItemClickListener {
    ...
    public void onClick() {
        ...
        if (style == 1) {//1去付款，2删除
            ...
            List<GoodsDetailsBean.ProductsBean> productsBeanList = new ArrayList<>();
            int orderNum = 0;
            for (ShopCarBean carBean : delecteList) {
                ...
                productsBean.setName(carBean.getGoodsName());
